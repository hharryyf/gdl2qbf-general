# QBF Instances for Adversarial Games in General Game Description Langauge (GDL)

The QBF instances answer the question: can a player get 100 points within n steps regardless of the actions of all the other players. The [GDL descriptions](http://ggp.stanford.edu/readings/gdl_spec.pdf) of the games are available [here](https://github.com/hharryyf/gdl2qbf-general/tree/main/SinglePlayer/GameDescriptions). 
...
If you use our instances, please cite the following paper:

```
@inproceedings{he2024solving,
