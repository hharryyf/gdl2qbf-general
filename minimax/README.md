...
* Instances generated by the [BDDL encoding](https://github.com/irfansha/Q-sage/) are available in the ```BDDL/``` directory

## Dependencies

* Swi-Prolog: https://www.swi-prolog.org/pldoc/man?section=cpp2
